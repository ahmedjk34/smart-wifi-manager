...
void RunTestCase(const BenchmarkTestCase& tc, std::ofstream& csv)
{
    ...
    // CHANGE HERE: Use SmartWifiManagerXgb instead of SmartWifiManagerV1
    wifi.SetRemoteStationManager("ns3::SmartWifiManagerXgb");
...
int main(int argc, char *argv[])
{
    ...
    std::ofstream csv("smartxgb-benchmark.csv");
    ...
    csv.close();
    std::cout << "All tests complete. Results in smartxgb-benchmark.csv\n";
    return 0;
}