...
void RunTestCase(const BenchmarkTestCase& tc, std::ofstream& csv)
{
    ...
    // CHANGE HERE: Use SmartWifiManagerV2 instead of AarfWifiManager
    wifi.SetRemoteStationManager("ns3::SmartWifiManagerV3");
...
int main(int argc, char *argv[])
{
    ...
    std::ofstream csv("smartv3-benchmark.csv");
